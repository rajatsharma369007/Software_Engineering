...
class Binomial(Distribution):
    ...
    def __init__(self, prob=.5, size=20):
        ...
        self.p = prob
        self.n = size
        Distributions.__init__(self, self.calculate_mean(), self.calculate_stdev())
    ...
    def replace_stats_with_data(self):
        ...
        Distributions.read_data_file(self, file_name)
    ...
    def pdf(self, k):
        ...
        function = (f(self.n)/(f(k) * f(self.n - k))) * (self.p ** k) * ((1 -  self.p) ** (self.n - k))
        return function
